"""
HealthGuard AI — Preprocessing Module.
Contains dataset-specific preprocessing pipelines for heart disease and diabetes models,
as well as the ClinicalOutlierClipper and general preprocessor for risk models.
"""
...
def build_preprocessor(feature_names: Optional[List[str]] = None) -> Pipeline:
    """
    ...
    3. Standard scaling for continuous numerical stability
    """
    return Pipeline([
