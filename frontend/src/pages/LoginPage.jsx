/**
 * @file LoginPage.jsx
 * HealthGuard AI Secure User Login Interface
 */
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-[11px] text-slate-400 font-mono">JWT v2.4</span>
            </div>
            ...
            <div className="space-y-1.5 mb-6">
              ...
              <p className="text-xs text-slate-400">
                Sign in to access your clinical risk stratification and health trends.
              </p>
            </div>
            ...
            <div className="mt-6 pt-5 border-t border-emerald-500/10">
              <button
                ...
                className={`w-full py-2.5 px-3 rounded-xl text-xs font-semibold border transition-all flex items-center justify-center gap-2 ${
                  isDark
                    ? 'bg-emerald-950/20 border-emerald-500/20 text-emerald-300 hover:bg-emerald-950/40 hover:border-emerald-400/40'
